...
class FlowerSerializer(serializers.ModelSerializer):
    ...
    default_variant = serializers.PrimaryKeyRelatedField(queryset=FlowerVariant.objects.all())
    ...
    media = serializers.PrimaryKeyRelatedField(many=True, queryset=FlowerMedia.objects.all())
