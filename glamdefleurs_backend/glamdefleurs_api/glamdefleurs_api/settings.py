"""
Django settings for glamdefleurs_api project.
...
SECRET_KEY = 'django-insecure--u3a0j7@*a$r)yv1egle89c5*kx^p(ye!n^@u5(u+@z)h#s6+m'
...
WSGI_APPLICATION = 'glamdefleurs_api.wsgi.application'
